<template>
  <div class="page">
    <header class="topbar">
      ...
      <div class="actions">
        <el-button type="primary" @click="openDialog()" v-perm="'sys:user:create'">新增用户</el-button>
      </div>
    </header>
    ...
    <section class="content">
      ...
      <el-table :data="list" border style="width: 100%">
        ...
        <el-table-column label="操作" width="220" fixed="right">
          <template #default="{ row }">
            <el-button size="small" @click="openDialog(row)" v-perm="'sys:user:update'">编辑</el-button>
            <el-button size="small" type="warning" @click="handleToggle(row)" v-perm="'sys:user:toggle'">
              {{ row.status === 1 ? '禁用' : '启用' }}
            </el-button>
            <el-button size="small" type="danger" @click="handleDelete(row)" v-perm="'sys:user:delete'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
const hasFormChanged = () => {
  ...
  return (
    form.nickname !== initialForm.value.nickname ||
